...
public interface ISchemaChangeHistoryService {
	...
	List<SchemaChangeHistoryDTO> search(Long databaseInfoId, Long tableId, String changeType, int page, int limit);
	int totalItemSearch(Long databaseInfoId, Long tableId, String changeType);
}
